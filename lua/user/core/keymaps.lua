...
keymap.set("n", "<C-h>", "<C-w>h") -- close current split window
keymap.set("n", "<C-j>", "<C-w>j") -- close current split window
keymap.set("n", "<C-k>", "<C-w>k") -- close current split window
keymap.set("n", "<C-l>", "<C-w>l") -- close current split window
